                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    <a href="{{ route('pembayaran.edit', ['id' => $item->id]) }}" class="btn btn-sm text-white bg-warning" data-id="{{ $item->id }}"><i class='fa fa-edit'> Edit</i></a>
                                    <a href="{{ route('pembayaran.delete', ['id' => $item->id]) }}" data-toggle="modal" data-target="#exampleModal{{$item->id}}" class="btn btn-sm text-white bg-danger"><i class='fa fa-trash'> Delete</i></i></a>
                            </td>
                        </tr>
                      @endforeach
            </div>
